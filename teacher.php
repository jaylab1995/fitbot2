        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div class="container-fluid" id="container-wrapper">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h1 class="h3 mb-0 text-gray-800">Teacher's Information</h1>
                ...
                <form action="update_teacher.php" method="post">
                  ...
                  <div class="form-row">
                    <div class="form-group col-lg-4 col-md-6 col-sm-12">
                      ...
                      <input type="text" class="form-control" id="teacher_id" name="teacher_id" value="<?php echo htmlspecialchars($teacher['teacher_id']); ?>" required readonly>
                    </div>
                    <div class="form-group col-lg-4 col-md-6 col-sm-12">
                    ...
                    <div class="form-group col-lg-4 col-md-6 col-sm-12">
                      ...
                      <select class="form-control" id="teacher_gender" name="teacher_gender" required>
                        <option value="Male" <?php if ($teacher['teacher_gender'] == 'Male') echo 'selected'; ?>>Male</option>
                        <option value="Female" <?php if ($teacher['teacher_gender'] == 'Female') echo 'selected'; ?>>Female</option>
                        <option value="Other" <?php if ($teacher['teacher_gender'] == 'Other') echo 'selected'; ?>>Other</option>
                      </select>
                    </div>
                  </div>
                  <div class="form-row">
                    <div class="form-group col-lg-4 col-md-6 col-sm-12">
                      ...
                      <input type="text" class="form-control" id="teacher_designation" name="teacher_designation" value="<?php echo htmlspecialchars($teacher['teacher_designation']); ?>" required>
                    </div>
                    <div class="form-group col-lg-4 col-md-6 col-sm-12">
                      <label for="teacher_username">Username</label>
                      <input type="text" class="form-control" id="teacher_username" name="teacher_username" value="<?php echo htmlspecialchars($teacher['teacher_username']); ?>" required title="Do not edit if you will not change your username">
                    </div>
                    <div class="form-group col-lg-4 col-md-6 col-sm-12">
                      <label for="teacher_password">Password</label>
                      <input minlength="6" type="password" class="form-control" id="teacher_password" name="teacher_password" title="Do not edit if you will not change your password">
                    </div>
                  </div>
