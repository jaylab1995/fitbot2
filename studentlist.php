...
$generateList = mysqli_query($conn, "SELECT * FROM students WHERE student_grade='$grade' AND student_section='$section' AND student_status='1' ORDER BY student_idnum ASC ");
      ...
      <li class="nav-item">
        ...
        <div id="collapsePage" class="collapse show" aria-labelledby="headingPage" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item <?=$grade==7 ? 'active' : ''; ?>" href="studentlist.php?grade=7&section=A">Grade 7</a>
            <a class="collapse-item <?=$grade==8 ? 'active' : ''; ?>" href="studentlist.php?grade=8&section=A">Grade 8</a>
            <a class="collapse-item <?=$grade==9 ? 'active' : ''; ?>" href="studentlist.php?grade=9&section=A">Grade 9</a>
            <a class="collapse-item <?=$grade==10 ? 'active' : ''; ?>" href="studentlist.php?grade=10&section=A">Grade 10</a>
            <a class="collapse-item <?=$grade==11 ? 'active' : ''; ?>" href="studentlist.php?grade=11&section=A">Grade 11</a>
            <a class="collapse-item <?=$grade==12 ? 'active' : ''; ?>" href="studentlist.php?grade=12&section=A">Grade 12</a>
          </div>
        </li>
        <li class="nav-item">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div class="container-fluid" id="container-wrapper">
            ...
            <label for="section" class="form-label mt-4">Select Section</label>
            <select name="section" class="form-control mb-5" style="width: 15em; height: 2em;" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">>
              <option <?=$section=='A' ? 'selected' : ''; ?> value="studentlist.php?grade=<?=$grade;?>&section=A">A</option>
              <option <?=$section=='B' ? 'selected' : ''; ?> value="studentlist.php?grade=<?=$grade;?>&section=B">B</option>
              <option <?=$section=='C' ? 'selected' : ''; ?> value="studentlist.php?grade=<?=$grade;?>&section=C">C</option>
              <option <?=$section=='D' ? 'selected' : ''; ?> value="studentlist.php?grade=<?=$grade;?>&section=D">D</option>
              <option <?=$section=='E' ? 'selected' : ''; ?> value="studentlist.php?grade=<?=$grade;?>&section=E">E</option>
            </select>
